 ...
 */
package com.project.shopcart.adapter.baseadapter;
...
public class BaseAdapterHelper {
     ...
     * @return The BaseAdapterHelper for chaining.
     */
    public BaseAdapterHelper setTextIsEmpty(int viewId, String value) {
        TextView view = retrieveView(viewId);
     ...
     * @return The BaseAdapterHelper for chaining.
     */
    public BaseAdapterHelper setTextByEmpty(int viewId, SpannableString value) {
        TextView view = retrieveView(viewId);
        if (!TextUtils.isEmpty(value)) {
            view.setVisibility(View.VISIBLE);
            view.setText(value);
...
//	}
     ...
     * @return The BaseAdapterHelper for chaining.
     */
    public BaseAdapterHelper setVisibleButPlace(int viewId, boolean visible) {
        View view = retrieveView(viewId);
